...
RSpec.describe Hmibo::TestHelpers do
  describe '#expect_service_success' do
    ...
    it 'fails when service has errors' do
      ...
      end.to raise_error(RSpec::Expectations::ExpectationNotMetError, /Expected service to succeed/)
    end
  end
  ...
  describe '#expect_service_failure' do
    ...
    it 'fails when service succeeds' do
      ...
      end.to raise_error(RSpec::Expectations::ExpectationNotMetError, /Expected service to fail/)
    end
    ...
    it "fails when error count doesn't match" do
      ...
      end.to raise_error(RSpec::Expectations::ExpectationNotMetError, /Expected 1 errors, but got 2/)
    end
  end
  ...
  describe '#expect_service_error' do
    ...
    it "fails when service doesn't have the expected error" do
      ...
      end.to raise_error(RSpec::Expectations::ExpectationNotMetError, /Expected error 'Expected error'/)
    end
    ...
    it 'fails when service succeeds' do
      ...
      end.to raise_error(RSpec::Expectations::ExpectationNotMetError, /Expected service to have errors/)
    end
  end
  ...
  describe '#expect_service_error_with_attributes' do
    ...
    it 'fails when no error matches the attributes' do
      ...
      end.to raise_error(RSpec::Expectations::ExpectationNotMetError, /Expected error with attributes/)
    end
  end
  ...
  describe '#mock_service' do
    ...
    it 'creates a mock service with errors' do
      mock = mock_service(success: false, errors: %w[error1 error2])

      expect(mock.errors?).to be(true)
      expect(mock.errors).to eq(%w[error1 error2])
    end
  end
